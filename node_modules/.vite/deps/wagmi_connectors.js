import {
  ...
  withRetry,
  withTimeout
} from "./chunk-UXH5X2QD.js";
import "./chunk-CQYF55CK.js";
import "./chunk-KIN3PNZD.js";
import {
  ...
  hexToNumber,
  numberToHex
} from "./chunk-NLZ4J653.js";
import "./chunk-IKTD2624.js";
import "./chunk-MKNR3RXO.js";
import "./chunk-4XKW7ZLP.js";
import "./chunk-5FQPHFZ2.js";
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./connectors_false-KF5Y7XX5.js");
...
function coinbaseWallet(parameters = {}) {
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        const { createCoinbaseWalletSDK } = await import("./connectors_false-BEVCZU7V.js");
...
function gemini(parameters = {}) {
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        const { GeminiWalletProvider } = await import("./connectors_false-CW6MIBLV.js");
    ...
    async getProvider() {
      async function initProvider() {
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./connectors_false-JF7SDE2V.js");
  ...
  return createConnector((wagmiConfig) => {
    ...
    return {
      async connect({ chainId = chains[0].id, ...rest } = {}) {
        ...
        try {
          if (!accounts?.length && !isReconnecting) {
            const { RpcSchema } = await import("./connectors_false-6S64CIYQ.js");
            const { z } = await import("./connectors_false-TTARY6V5.js");
      ...
      async getPortoInstance() {
        porto_promise ??= (async () => {
          const { Porto } = await import("./connectors_false-6S64CIYQ.js");
          return Porto.create({
            ...parameters,
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./connectors_false-2QMMQX6W.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./connectors_false-TR37XF3F.js");
    ...
    async getProvider({ chainId } = {}) {
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./connectors_false-IOY6JDVR.js");
