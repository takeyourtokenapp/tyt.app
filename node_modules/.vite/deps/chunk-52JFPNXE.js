import {
  ...
  validate2,
  withResolvers
} from "./chunk-MT4ETI57.js";
import {
  secp256k1
} from "./chunk-NQ6RQEVH.js";
import {
...
import {
  ...
  HashMD,
  Maj
} from "./chunk-MKNR3RXO.js";
import {
  clean,
  createHasher,
  rotl
} from "./chunk-5FQPHFZ2.js";
import {
  __commonJS,
  __export,
  __toESM
...
async function getWebSocketRpcClient(url, options = {}) {
  ...
  return getSocketRpcClient({
    async getSocket({ onClose, onError, onOpen, onResponse }) {
      const WebSocket = await import("./native-RJHHWWR4.js").then((module) => module.WebSocket);
...
async function recoverPublicKey({ hash: hash2, signature }) {
  ...
  const { secp256k1: secp256k12 } = await import("./secp256k1-AGG4OSRT.js");
  const signature_ = (() => {
...
async function prepareTransactionRequest(client, args) {
  ...
  if (prepareTransactionRequest3?.fn && prepareTransactionRequest3.runAt?.includes("beforeFillTransaction")) {
    request = await prepareTransactionRequest3.fn(request, {
            ...
            const { result: result2, error: error2 } = await rpc.http(url, {
              body: {
                ...
                params: [
                  {
                    ...call3,
                    ...typeof from14 !== "undefined" ? { from: from14 } : {}
                  }
                ]
              }
            });
...
//# sourceMappingURL=chunk-52JFPNXE.js.map
